...
def scrape_data(search_string):
    try:
        ...
        logging.info(f"Scraping URL: {flipkart_url}")
        ...
        # Add more logging to print the HTML structure
        logging.info(f"HTML structure: {bigboxes}")

        if not bigboxes:
            logging.warning("No review boxes found on the page.")
            return []
        ...
        # Add more logging to print the comment boxes
        logging.info(f"Comment boxes: {comment_box}")
